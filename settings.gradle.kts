...
include(":datasource:remote:subscription:api")
include(":datasource:remote:subscription:impl")
...
include(":data:repository:subscription:api")
include(":data:repository:subscription:impl")
...
include(":platform:intent:api")
include(":platform:intent:impl")
include(":shared:poc")
