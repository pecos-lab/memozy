...
include(":datasource:local:pet:api")
include(":datasource:local:pet:impl")
include(":data:repository:pet:api")
include(":data:repository:pet:impl")
include(":feature:pet:api")
include(":feature:pet:impl")
