---
description: "코드 수정/생성 시 필수 규칙. 기능 추가, 버그 수정, 리팩토링 등 모든 코드 작업 전 활성화."
---
...
### 디버깅/버그 수정 시 (추가)
- 직접 코드 수정 + 빌드 검증까지 완료할 것
- 질문 없이 일단 수정하고 결과 보고할 것
- 원인 → 수정 → 빌드 → 결과를 한 사이클로 처리할 것
